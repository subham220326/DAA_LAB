...
Below is the computational output evaluating all 11 mathematical functions for increasing values of `n` (from 10 to 50).
...
### 3. Linear Function with Large Constant (`2^32 * n`)
